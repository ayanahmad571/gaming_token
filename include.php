...
Gamers Section General Trading LLC<br>
Office 704, Tower 51, Buisness Bay<br>
...
'termsandconditions'=>'<h6>PLEASE NOTE:&nbsp;<br>1.)The above quoted price &amp; quantity&nbsp; as based on layout provided by client (wastage included).&nbsp;<br>2.)Any additional quantity will require for this site will be charge extra.<br>3) Installation is subject to getting unhindered access to dry,flat,levelled to and smooth subfloor.&nbsp;<br>4.) Floor should be fully dry,free from all moisture,dust and dirt.&nbsp;<br>5.)A/C should be commissioned and functional,prior to the installation.&nbsp;<br>6.)FREE electricity for the working of 220 volts machines and water to be provided on site by the client.&nbsp;<br>7.)Unloading at site,hoisting,crainage,lighting and lockable storage facilities to be provided free of cost by the client/contractor&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>8.) We will not bear any penalty for the job undertaken.&nbsp;<br>9.) Client has to provide storage facility and any damge and misplace material after delivery will be responsibilty of client.&nbsp;<br>10.) We do not accept remeasurement jobs / contract.&nbsp;<br>11.) All the necessary approval from Municipality or other authorities is the sole responsibility of client.&nbsp;<br>12.) Removal of furniture and other heavy items will not be in our scope and has to be removed by client&nbsp;&nbsp;<br>13.) additional charges will be applicable if in case we removed furniture from the site, cost will be depend upon size of furniture&nbsp;<br>14) Our price is for selected model and color, Change in Design &amp; Color may change in price and lead time&nbsp;<br>15.) Change in color is subject to manufacturer confirmation and provided price is only for same design and colors&nbsp;<br>16.)&nbsp;Additional Accessories, Profiles, Beadings &amp; Skirting as per site requirements will be charged extra.&nbsp;&nbsp;<br>17.) Please note that the Floor box cutting charges will be extra and it will cost AED 50/- each.&nbsp;<br>18.) By confirming this order,all above terms and conditions come into effect.&nbsp;<br>19.) All payments to be in favour of Stile Well General Trading LLC.&nbsp;<br><br><i><u>TERMS &amp; CONDITION</u></i>:&nbsp;<br>Quote Validity&nbsp; : 15 days.&nbsp;<br>Delivery&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp; To be discussed&nbsp;<br>Payment&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 75% amount advance on order conformation &amp; balance 25% (15 days PDC) upon delivery and before installation.&nbsp;</h6><h6>Looking forward to your continuous patronage while assuring you of our best / time attention &amp; services at all.</h6><h5><div><div></div></div></h5>
	...
	echo '<!-- brand -->
            <div class="logo">
				...
				<a href="#" class="logo-expanded">
                    <img style="align-self:center;width:110px !important"  src="img/logo.jpg" class="img-responsive" />
                </a>
            </div>
            <!-- / brand -->';
}
...
$sql = "SELECT * FROM `sw_modules` where mo_valid =1 and FIND_IN_SET(".$_SESSION['TKSYS_LUM_TU_ID'].", mo_for) > 0";
...
<?php
        ...
        <meta name="description" content="Gamer Token SYS">
        <meta name="author" content="AnonymousAhmad">

        <link rel="shortcut icon" href="img/logo.jpg">

        <title>Token System Admin Panel</title>
